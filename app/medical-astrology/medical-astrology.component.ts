...
@Component({
  selector: 'app-medical-astrology',
  templateUrl: './medical-astrology.component.html',
  styleUrls: ['./medical-astrology.component.css'],
})
export class MedicalAstrologyComponent implements OnInit {

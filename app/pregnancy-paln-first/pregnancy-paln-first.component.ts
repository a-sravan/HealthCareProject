...
@Component({
  selector: 'app-pregnancy-paln-first',
  templateUrl: './pregnancy-paln-first.component.html',
  styleUrls: ['./pregnancy-paln-first.component.css'],
})
export class PregnancyPalnFirstComponent implements OnInit {
  public callInfo: any;

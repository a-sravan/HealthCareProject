...
@Component({
  selector: 'app-elderlycare',
  templateUrl: './elderlycare.component.html',
  styleUrls: ['./elderlycare.component.css'],
})
export class ElderlycareComponent implements OnInit {
  ...
  configelderlyplan: SwiperOptions = {
    slidesPerView: 2,
    spaceBetween: 5,
    lazy: true,
    navigation: {
  ...
  confignewpaertner: SwiperOptions = {
    slidesPerView: 5,
    spaceBetween: 5,
    navigation: {
      enabled: true,
